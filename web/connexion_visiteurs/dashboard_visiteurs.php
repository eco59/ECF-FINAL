...
<body>
    ...
    <section class="description_de_la_page_membre">
        <p>Bienvenue dans votre espace membre !
        </p>
    </section>
    <section class="button_membre">
        <a href="../connexion_visiteurs/favori.php">
            <button class="button_favori">Favoris</button>
        </a>
        <a class="a_button_deco" href="../deconnexion/logout.php">
