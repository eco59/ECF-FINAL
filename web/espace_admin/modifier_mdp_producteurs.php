...
<body>
    ...
    <section class="condition">
        <p>Modifier le mot de passe producteurs
        </p>
    </section>
    <section class="se_connecter_admin">
        <div class="login_admin">
            <form action="" method="POST">
                <input class="admin" type="text" id="email" name="email" placeholder="Entrer votre adresse mail"  required>
                ...
                <?php
                    ...
                    if(isset($_POST['ok'])){
                        ...
                        $changermdp = $bdd->prepare('UPDATE producteurs SET mdp = ?, email = ? WHERE email = ?');
